...
<div class="container">
	...
	<p>
	    ...
	    you have successfully authenticated your character. Follow the steps below to sign-up for <a href="https://brave-collective.slack.com" target="_blank">https://brave-collective.slack.com</a>.<br>
	    <span style="font-size:70%;">
		It is strongly recommened to <a href="https://slack.com/downloads" target="_blank">install</a> the slack desktop and mobile clients.
	    </span>
	</p>
	<br>
    </div>
	...
	<div class="col-xs-4">
		...
		<div class="panel-body">
			...
			<p style="text-align:center;">
			    ...
			    <br>
			    <input id='textMail' placeholder="Email Address" type="email"> <button type="submit" class="btn btn-primary btn-sm" onClick="invite('<?php echo $_SESSION['nonce']; ?>', $('#textMail').val());">Invite</button>
			</p>
			<p style="font-size:80%;">
			    Please be aware that this is a manual process - it can take <b>several days</b> for your request to be processed<br>
			    The email address you use to sign-up will be visible to all slack members, don't <b>doxx yourself</b> by accident.<br>
			</p>
		    </div>
		</div>
	    </div>
	...
	<div class="col-xs-4">
		...
		<div class="panel-body">
			...
			<p style="text-align:center;">
			    A few hours after signing up, you will receive a message asking to <b>verify</b> your account.<br>
			    <br>
			    <input id="textCode" placeholder="Verification Code" type="text"> <button type="submit" class="btn btn-primary btn-sm" onClick="verify('<?php echo $_SESSION['nonce']; ?>', $('#textCode').val());">Verify</button>
			</p>
			<p style="font-size:80%;">
